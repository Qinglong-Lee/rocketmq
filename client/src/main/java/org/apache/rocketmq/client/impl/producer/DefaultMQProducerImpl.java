...
public class DefaultMQProducerImpl implements MQProducerInner {
    ...
    //liqinglong: 在生产者发送消息的时候才会指定要向哪个【topic】发送
    //然后将【绑定的topic信息】缓存到【topicPublishInfoTable】中
    //【mQClientFactory.updateTopicRouteInfoFromNameServer(topic)】是立即根据缓存的【topic】信息从【nameserver】查询路由信息
    //在【MQClientInstance】启动时开启的【updateTopicRouteInfoFromNameServer】定时任务中
    //也会从【topicPublishInfoTable】中获取生产者绑定的【topic】去【nameserver】定时查询【路由信息】
    private TopicPublishInfo tryToFindTopicPublishInfo(final String topic) {
        ...
        if (topicPublishInfo.isHaveTopicRouterInfo() || topicPublishInfo.ok()) {
            ...
            //liqinglong: 如果当前【topic】在【nameServer】没有路由信息，就尝试去【自动创建topic】
            //【自动创建topic】的前提是【broker开启了自动创建配置】，否则会抛异常【No route info of this topic】
            //原理是利用【TBW102】这个【所有自动创建测topic的父topic】去创建
            //因为【自动创建的topic】的路由信息【继承】自【TBW102】
            //所以第一次路由信息获取直接从【TBW102】获取路由信息即可，即【isDefault=true】，之后就可以从【已创建的topic】中获取
