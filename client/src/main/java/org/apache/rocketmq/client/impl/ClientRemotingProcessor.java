...
public class ClientRemotingProcessor extends AsyncNettyRequestProcessor implements NettyRequestProcessor {
    ...
    public RemotingCommand processRequest(ChannelHandlerContext ctx,
        ...
        switch (request.getCode()) {
            ...
            //liqinglong: 处理【broker】【客户端数量更新】通知
    ...
    //liqinglong: 处理【broker】【客户端数量更新】的通知
    public RemotingCommand notifyConsumerIdsChanged(ChannelHandlerContext ctx,
        ...
        try {
            ...
            //liqinglong: 当组内客户端信息发生变化，处理方式就是【重新负载均衡】以实现【队列重分配】
            //此处会调用【rebalanceService.wakeup()】唤醒负载均衡线程
            //负载均衡服务会先去【broker】获取所有【更新后的客户端组信息】，然后根据分配策略做【队列重分配】
            //所以不需要【broker】主动发送【更新后的客户端组信息】到【客户端端】
