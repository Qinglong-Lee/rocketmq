...
public class BrokerController {
    ...
    //liqinglong: broker】到【client】之间通信的封装类
    ...
    public boolean initialize() throws CloneNotSupportedException {
        ...
        if (result) {
            ...
            //liqinglong: 这里是【VIP Channel】的端口配置
            //即会启动一个以 broker 配置端口 - 2 为端口的 VIP 通道
            //所以在配置 broker 集群端口号的时候要注意不要用连续的端口号（30911,30912,30913），而应该间隔开（30911,30921,30931）
            //否则当启动 30913 的时候会启动 30913-2=30911，如果 30911 已经启动，就会冲突，导致 30913 启动失败
